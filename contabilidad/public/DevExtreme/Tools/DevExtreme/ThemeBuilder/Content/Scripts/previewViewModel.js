(function(ThemeBuilder) {
    ...
    var PreviewViewModel = function(cssTemplateLoader, previewRepository, parentIframeNotifier) {
        ...
        this.init = function(metadata, group) {
            ...
            this.isMobileTheme($.inArray(theme, ["ios7", "android5", "win10"]) > -1);

            this.themeColoring($.inArray(colorScheme, ["light", "light-compact", "white", "default"]) > -1 ? "coloring-light" : "coloring-dark");
