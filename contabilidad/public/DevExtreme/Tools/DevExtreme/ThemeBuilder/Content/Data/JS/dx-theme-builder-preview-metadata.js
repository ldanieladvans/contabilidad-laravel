...
ThemeBuilder.__base_common_group = function() { return {
    "id": "base.common",
    "useFieldsetForThemes": [ "ios7-default", "android5-light", "win10-black", "win10-white" ],
    "widgets": [
        {
            "name": "dxDataGrid",
...

        {
            "name": "dxTextBox",
            "title": "dxTextBox",
            "supportedThemes": [ "ios7-default", "android5-light", "win10-black", "win10-white" ],
            "options": {
        ...
        },
        {
            "name": "dxButton",
            "title": "dxButton",
            "supportedThemes": [ "ios7-default", "win10-black", "win10-white" ],
            "options": {
                "text": "Normal Button",
                "type": "normal"
            }
...
"widgets": [
    {
        "name": "dxScrollView",
        "supportedThemes": [ "generic-light", "generic-dark", "generic-light-compact", "generic-dark-compact", "win10-black", "win10-white"],
...
"widgets": [
    {
        "name": "dxButton",
        "supportedThemes": [ "generic-dark", "generic-light", "generic-light-compact", "generic-dark-compact", "android5-light", "win10-white", "win10-black" ],
        "options": {
            "text": "Danger",
            "type": "danger"
        }
...
"widgets": [
    {
        "name": "dxButton",
        "supportedThemes": [ "generic-dark", "generic-light", "generic-light-compact", "generic-dark-compact", "android5-light" ],
        "options": {
            "text": "Default",
            "type": "default"
        }
...
"widgets": [
	...
	},
	{
		"name": "dxButton",
		"title": "dxActionSheet",
		"supportedThemes": ["generic-light", "generic-dark", "generic-light-compact", "generic-dark-compact"],
		"options": {
			"text": "Show actionsheet",
			"click": "SHOW_ACTIONSHEET"
		}
...
"widgets": [
    ...
    },
    {
        "name": "dxScheduler",
        "id": "scheduler-preview",
        "supportedThemes":  [ "android5-light", "ios7-default", "win10-black", "win10-white" ],
        "options": {
            "views": [ "month", "week", "day" ],
            "currentDate":  1433106000000,
            "currentView": "week",
