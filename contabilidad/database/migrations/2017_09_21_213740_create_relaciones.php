...
class CreateRelaciones extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('ctacont', function($table)
            {
                $table->integer('ctacont_tiposubcta_id')->unsigned()->nullable();
        ...
        Schema::table('period', function($table)
            {
                ...
                $table->foreign('period_ejerc_id')->references('id')->on('ejerc')->onDelete('cascade');
            });

        Schema::table('polz', function($table)
            {
                $table->integer('polz_period_id')->unsigned()->nullable();
                $table->foreign('polz_period_id')->references('id')->on('period')->onDelete('set null');
            });

        Schema::table('blnza', function($table)
            {
                $table->integer('blnza_period_id')->unsigned()->nullable();
                $table->foreign('blnza_period_id')->references('id')->on('period')->onDelete('set null');

                $table->integer('blnza_ctacont_id')->unsigned()->nullable();
        ...
        Schema::table('provis', function($table)
            {
                ...
                $table->foreign('provis_comp_id')->references('id')->on('comp')->onDelete('cascade');
            });

        Schema::table('pago', function($table)
            {
                $table->integer('pago_comp_id')->unsigned();
                $table->foreign('pago_comp_id')->references('id')->on('comp')->onDelete('cascade');

                $table->integer('pago_polz_id')->unsigned()->nullable();
        ...
        Schema::table('pagoimp', function($table)
            {
                ...
                $table->foreign('pagoimp_pago_id')->references('id')->on('pago')->onDelete('cascade');
            });

        Schema::table('impdet', function($table)
            {
                $table->integer('impdet_pagoimp_id')->unsigned();
                $table->foreign('impdet_pagoimp_id')->references('id')->on('pagoimp')->onDelete('cascade');
            });

        Schema::table('polzcomp', function($table)
            {
                $table->integer('polzcomp_polz_id')->unsigned();
                $table->foreign('polzcomp_polz_id')->references('id')->on('polz')->onDelete('cascade');

                $table->integer('polzcomp_comp_id')->unsigned();
                $table->foreign('polzcomp_comp_id')->references('id')->on('comp')->onDelete('cascade');
            });

        Schema::table('pagorel', function($table)
            {
                $table->integer('pagorel_pago_id')->unsigned();
                $table->foreign('pagorel_pago_id')->references('id')->on('pago')->onDelete('cascade');

                $table->integer('pagorel_asiento_id')->unsigned()->nullable();
         ...
         Schema::table('prodingr', function($table)
            {
                ...
                $table->foreign('prodingr_tipcliente_id')->references('id')->on('tipcliente')->onDelete('cascade');

                $table->integer('prodingr_cliente_id')->unsigned()->nullable();
                $table->foreign('prodingr_cliente_id')->references('id')->on('cliente')->onDelete('cascade');

                $table->integer('prodingr_cta_ingr_id')->unsigned();
                $table->foreign('prodingr_cta_ingr_id')->references('id')->on('ctacont')->onDelete('cascade');
            });
         ...
         Schema::table('prodgast', function($table)
            {
                ...
                $table->foreign('prodgast_tipprov_id')->references('id')->on('tipprov')->onDelete('cascade');

                $table->integer('prodgast_proveed_id')->unsigned()->nullable();
                $table->foreign('prodgast_proveed_id')->references('id')->on('proveed')->onDelete('cascade');

                $table->integer('prodgast_cta_gast_id')->unsigned();
                $table->foreign('prodgast_cta_gast_id')->references('id')->on('ctacont')->onDelete('cascade');
            });
