	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	    <ul class="breadcrumb">
	        <li>
	            ...
	            <a href="#">Actualizar Pago Relacionado</a>
	        </li>
	    </ul>
	</div>
@endsection
...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				{{ Form::open(['route' => ['pagosrel.update', $pagorel->id], 'class'=>'form-horizontal form-label-left', 'method'=>'PUT', 'id'=>'editapagorel']) }}
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="pagorel_pagado_uuid" id="pagorel_pagado_uuid" class="col-md-10 col-sm-10 col-xs-12" value="{{$pagorel->pagorel_pagado_uuid}}"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="text" name="pagorel_serie" id="pagorel_serie" class="col-md-12 col-sm-12 col-xs-12" value="{{$pagorel->pagorel_serie}}"/>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="text" name="pagorel_folio" id="pagorel_folio" class="col-md-10 col-sm-10 col-xs-12" value="{{$pagorel->pagorel_folio}}"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<select class="js-example-basic-single js-states form-control" id="pagorel_metpago_cod" name="pagorel_metpago_cod" data-placeholder="Seleccione el método de pago SAT ..." style="width: 83%; display: none;">
								<option value="PUE" {{$pagorel->pagorel_metpago_cod == 'PUE'}}>PUE</option>
                            	<option value="PPD" {{$pagorel->pagorel_metpago_cod == 'PPD'}}>PPD</option>
							</select>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<select class="js-example-basic-single js-states form-control" id="pagorel_moneda_cod" name="pagorel_moneda_cod" data-placeholder="Seleccione la moneda ..." style="width: 83%; display: none;">
									@foreach($pagorel_moneda_cod as $tp)
		                            	<option value="{{ trim($tp->cat_sat_monedas_codigo) }}" {{trim($pagorel->pagorel_moneda_cod) == trim($tp->cat_sat_monedas_codigo) ? 'selected':''}}>{{ $tp->cat_sat_monedas_nombre }}</option>
		                            @endforeach
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="number" name="pagorel_tipo_cambio" id="pagorel_tipo_cambio" class="col-md-12 col-sm-12 col-xs-12" value="{{$pagorel->pagorel_tipo_cambio}}"/>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="number" name="pagorel_numparcldad" id="pagorel_numparcldad" class="col-md-10 col-sm-10 col-xs-12" value="{{$pagorel->pagorel_numparcldad}}"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="clearfix">
								<input type="number" name="pagorel_sald_ant" id="pagorel_sald_ant" class="col-md-12 col-sm-12 col-xs-12" value="{{$pagorel->pagorel_sald_ant}}"/>
							</div>
						</div>
						...
						<div class="col-md-2 col-sm-2 col-xs-12">
							<div class="clearfix">
								<input type="number" name="pagorel_monto_pag" id="pagorel_monto_pag" class="col-md-12 col-sm-12 col-xs-12" value="{{$pagorel->pagorel_monto_pag}}"/>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
							<div class="clearfix">
								<input type="number" name="pagorel_sald_nuevo" id="pagorel_sald_nuevo" class="col-md-9 col-sm-9 col-xs-12" value="{{$pagorel->pagorel_sald_nuevo}}"/>
							</div>
						</div>
					</div>
