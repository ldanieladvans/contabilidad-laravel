		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				...
				{{ Form::open(['route' => ['proveedores.update', $proveedor->id], 'class'=>'form-horizontal form-label-left', 'method'=>'PUT', 'id'=>'editaproveedor']) }}
                	...
                	<input type="hidden" value="{{$proveedor}}" id="proveedor"/>
...
@section('app_js')
		...
		<script type="text/javascript">
	    	...
	    	var proveedor = jQuery.parseJSON(document.getElementById("proveedor").value);
			...
			$("#gridContainer").dxDataGrid({
		        ...
		        onRowInserted: function(e) {
		            ...
		            $.ajax({
		                url: '/prodgast',
		                type: 'POST',
		                data: {_token: CSRF_TOKEN,prodgast_cod_prod:e.data.prodgast_cod_prod,prodgast_tipprov_id:'false',prodgast_proveed_id:proveedor.id,prodgast_cta_gast_id:e.data.prodgast_cta_gast_id,crudmethod:'create',row_id:'false'},
		                dataType: 'JSON',
		                success: function (data) {
		            	    $('#loadingmodal').modal('hide');
		        ...
		        onRowUpdated: function(e) {
		            ...
		            $.ajax({
		                url: '/prodgast',
		                type: 'POST',
		                data: {_token: CSRF_TOKEN,prodgast_cod_prod:e.key.prodgast_cod_prod,prodgast_tipprov_id:'false',prodgast_proveed_id:proveedor.id,prodgast_cta_gast_id:e.key.prodgast_cta_gast_id,crudmethod:'edit',row_id:e.key.ID},
		                dataType: 'JSON',
		                success: function (data) {
		            	    $('#loadingmodal').modal('hide');
		            	    var thisgrid = $("#gridContainer").dxDataGrid('instance');
		        ...
		        onRowRemoving: function(e) {
		            ...
		            $.ajax({
		                url: '/prodgast',
		                type: 'POST',
		                data: {_token: CSRF_TOKEN,prodgast_cod_prod:e.data.prodgast_cod_prod,prodgast_tipprov_id:'false',prodgast_proveed_id:proveedor.id,prodgast_cta_gast_id:e.data.prodgast_cta_gast_id,crudmethod:'delete',row_id:e.key.ID},
		                dataType: 'JSON',
		                success: function (data) {
		            	    $('#loadingmodal').modal('hide');
		            	    var thisgrid = $("#gridContainer").dxDataGrid('instance');
