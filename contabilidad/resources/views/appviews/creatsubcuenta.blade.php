	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	    <ul class="breadcrumb">
	        <li>
	            ...
	            <a href="#">Crear Tipo de Sub-Cuenta</a>
	        </li>
	    </ul>
	</div>
@endsection
...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('tsubcuentas.store') }}" method='POST' id="creatsubcuenta">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="tiposubcta_nom" id="tiposubcta_nom" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="tiposubcta_mostrar_tab">Mostrar ?: </label>
						    <div class="col-md-10 col-sm-10 col-xs-12">
						    	<label>
									<input name="tiposubcta_mostrar_tab" id="tiposubcta_mostrar_tab" class="ace ace-switch" type="checkbox" checked/>
