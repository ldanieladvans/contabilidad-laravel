	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	    <ul class="breadcrumb">
	        <li>
	            ...
	            <a href="#">Actualizar Tipo de Sub-Cuenta</a>
	        </li>
	    </ul>
	</div>
@endsection
...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				{{ Form::open(['route' => ['tsubcuentas.update', $tsubcuenta->id], 'class'=>'form-horizontal form-label-left', 'method'=>'PUT', 'id'=>'editatsubcuenta']) }}
                	{{ Form::hidden('_method', 'PUT') }}

					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-1 col-md-1" for="tiposubcta_nom">Nombre:</label>
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="tiposubcta_nom" id="tiposubcta_nom" class="col-md-10 col-sm-10 col-xs-12" value="{{$tsubcuenta->tiposubcta_nom}}"/>
							</div>
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="tiposubcta_mostrar_tab">Mostrar ?: </label>
						    <div class="col-md-10 col-sm-10 col-xs-12">
						    	<label>
									<input name="tiposubcta_mostrar_tab" id="tiposubcta_mostrar_tab" class="ace ace-switch" type="checkbox" {{$tsubcuenta->tiposubcta_mostrar_tab ? 'checked':''}}/>
					...
					<div class="ln_solid"></div>
                        <div class="form-group">
	                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
	                            <button id="cancel" type="button" onclick="location.href = '/tsubcuentas';" class="btn btn-info">Cancelar</button>
