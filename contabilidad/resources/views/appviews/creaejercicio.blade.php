...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('ejercicios.store') }}" method='POST' id="creaejercicio">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-md-9 col-sm-9 col-xs-12">
							<input type="number" name="ejerc_anio" id="ejerc_anio"/>
						</div>
					</div>
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="ejerc_cerrado">Ejericio Cerrado ?: </label>
											    <div class="col-md-2 col-sm-2 col-xs-12">
											    	<label>
														<input name="ejerc_cerrado" id="ejerc_cerrado" class="ace ace-switch" type="checkbox"/>
