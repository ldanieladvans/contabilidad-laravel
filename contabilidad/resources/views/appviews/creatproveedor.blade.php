	...
	<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	    <ul class="breadcrumb">
	        <li>
	            ...
	            <a href="#">Crea Tipo de Proveedor</a>
	        </li>
	    </ul>
	</div>
@endsection
...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('tproveedores.store') }}" method='POST' id="creatproveedor">
					{{ csrf_field() }}
					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-2 col-md-2" for="tipprov_desc">Nombre/Descripción:</label>
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="tipprov_desc" id="tipprov_desc" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
											...
											<tr>
												<td width="50%">
													<div class="form-group">
														...
														<div class="col-md-10 col-sm-10 col-xs-12">
															<div class="clearfix">
																<input type="text" name="tipprov_concpto_polz" id="tipprov_concpto_polz" class="col-md-10 col-sm-10 col-xs-12"/>
															</div>
														</div>
													</div>
												</td>
					...
					<div class="ln_solid"></div>
                        <div class="form-group">
	                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
	                            <button id="cancel" type="button" onclick="location.href = '/tproveedores';" class="btn btn-info">Cancelar</button>
