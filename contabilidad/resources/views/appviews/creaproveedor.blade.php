...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('proveedores.store') }}" method='POST' id="creaproveedor">
					{{ csrf_field() }}
					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-1 col-md-1" for="proveed_nom">Nombre:</label>
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="proveed_nom" id="proveed_nom" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="proveed_rfc" id="proveed_rfc" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="email" name="proveed_email" id="proveed_email" class="col-md-12 col-sm-9 col-xs-12"/>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="tel" name="proveed_tel" id="proveed_tel" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<select class="js-example-basic-single js-states form-control" id="proveed_tipprov_id" name="proveed_tipprov_id" data-placeholder="Seleccione el tipo de proveedor ..." style="width: 83%; display: none;">
								@foreach($tipoproveedor as $tp)
	                            	<option value="{{ $tp->id }}">{{ $tp->tipprov_desc }}</option>
	                            @endforeach
							</select>
						</div>
					</div>
											...
											<tr>
												<td width="50%">
													<div class="form-group">
														...
														<div class="col-md-10 col-sm-10 col-xs-12">
															<div class="clearfix">
																<input type="text" name="proveed_concepto_polz" id="proveed_concepto_polz" class="col-md-10 col-sm-10 col-xs-12"/>
															</div>
														</div>
													</div>
												</td>
																...
																<div class="widget-main">
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="text" id="proveed_nom_contct" name="proveed_nom_contct"/>
																		</div>
																	</div>
																	...
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="tel" id="proveed_tel_contct" name="proveed_tel_contct"/>
																		</div>
																	</div>
																	...
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="tel" id="proveed_email_contct" name="proveed_email_contct"/>
																		</div>
																	</div>
																...
																<div class="widget-main">
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="text" id="proveed_nom_contct_otro" name="proveed_nom_contct_otro"/>
																		</div>
																	</div>
																	...
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="tel" id="proveed_tel_contct_otro" name="proveed_tel_contct_otro"/>
																		</div>
																	</div>
																	...
																	<div>
																		...
																		<div class="input-group">
																			...
																			<input class="form-control" type="tel" id="proveed_email_contct_otro" name="proveed_email_contct_otro"/>
																		</div>
																	</div>
