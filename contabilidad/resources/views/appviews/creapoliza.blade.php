...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('polizas.store') }}" method='POST' id="creapago">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="polz_concepto" id="polz_concepto" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="text" name="polz_folio" id="polz_folio" class="col-md-12 col-sm-12 col-xs-12"/>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="date" name="polz_fecha" id="polz_fecha" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="number" name="polz_importe" id="polz_importe" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
									...
									<div id="home" class="tab-pane fade in active">
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="polz_aprobado">Aprobada ?: </label>
											    <div class="col-md-2 col-sm-2 col-xs-12">
											    	<label>
														<input name="polz_aprobado" id="polz_aprobado" class="ace ace-switch" type="checkbox"/>
										    ...
										    <div class="col-md-2 col-sm-2 col-xs-12">
										    	<label>
													<input name="polz_importada" id="polz_importada" class="ace ace-switch" type="checkbox"/>
													<span class="lbl" data-lbl="Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No"></span>
												</label>
											</div>
										    ...
										    <div class="col-md-2 col-sm-2 col-xs-12">
										    	<label>
													<input name="polz_activo" id="polz_activo" class="ace ace-switch" type="checkbox"/>
													<span class="lbl" data-lbl="Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No"></span>
												</label>
											</div>
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="polz_cierre">Es de cierre ?: </label>
											    <div class="col-md-2 col-sm-2 col-xs-12">
											    	<label>
														<input name="polz_cierre" id="polz_cierre" class="ace ace-switch" type="checkbox"/>
														<span class="lbl" data-lbl="Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No"></span>
													</label>
												</div>
										    ...
										    <div class="col-md-2 col-sm-2 col-xs-12">
										    	<label>
													<input name="polz_modificada" id="polz_modificada" class="ace ace-switch" type="checkbox"/>
													<span class="lbl" data-lbl="Si&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No"></span>
												</label>
											</div>
