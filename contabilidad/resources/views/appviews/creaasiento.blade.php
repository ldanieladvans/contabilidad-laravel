...
@section('variable_content')
	<div class="row">
		...
		<!-- Div contenedor del formulario -->
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form class="form-horizontal" action="{{ route('asientos.store') }}" method='POST' id="creaasiento">
					{{ csrf_field() }}
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="asiento_concepto" id="asiento_concepto" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="number" name="asiento_debe" id="asiento_debe" class="col-md-12 col-sm-12 col-xs-12"/>
							</div>
						</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<div class="clearfix">
								<input type="number" name="asiento_haber" id="asiento_haber" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="clearfix">
								<input type="text" name="asiento_folio_ref" id="asiento_folio_ref" class="col-md-10 col-sm-10 col-xs-12"/>
							</div>
						</div>
					</div>
						...
						<div class="col-md-4 col-sm-4 col-xs-12">
							<select class="js-example-basic-single js-states form-control" id="asiento_polz_id" name="asiento_polz_id" data-placeholder="Seleccione la póliza ..." style="width: 83%; display: none;">
                            	...
                            	@foreach($polizas as $pol)
									<option value="{{ $pol->id }}" >{{ $pol->polz_folio }}</option>
								@endforeach
							</select>
						</div>
								...
								<div class="tab-content">
										...
										<div class="form-group">
											<label class="control-label col-md-2 col-sm-2 col-xs-12" for="asiento_activo">Activo ?: </label>
											    <div class="col-md-2 col-sm-2 col-xs-12">
											    	<label>
														<input name="asiento_activo" id="asiento_activo" class="ace ace-switch" type="checkbox" checked />
									...
									<div id="pays" class="tab-pane fade">
										...
										<label for="polizas">Pagos: </label>
											<select multiple="multiple" class="js-example-basic-multiple" id="pagos" name="pagos[]" data-placeholder="Seleccione ..." style="width: 83%; display: none;">
												@foreach($pagos as $pg)
													<option value="{{$pg->id}}">{{$pg->pago_numoperc}}</option>
												@endforeach
											</select>
										</div>
